...
private static final String CLASSIC_CATEGORY = "classic";
	...
	public ClassicAdapter(Context c, int firstId, int lastId) {
		mContext = c;
		...
		loadEmojiClassic(firstId, lastId);
	}
	...
	private void loadEmojiClassic(int first, int last) {
		String drawableName = null;
		int drawableId = 0;
		for (int i = first; i != last+1; ++i) {
			drawableName = CLASSIC_CATEGORY + i; 
